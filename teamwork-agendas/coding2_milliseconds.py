...
# Learning Outcomes:
# At the end of the this coding challenge, students will be able to;analyze a problem, identify and apply programming knowledge for appropriate solution.
# design, implement while loops effectively in Python to solve the given problem.control loops effectively by using if and control statements.
# apply arithmetic operations on basic data types in Python.demonstrate their knowledge of string manipulations and formatting in Python.
# demonstrate their knowledge of algorithmic design principles by using function effectively.

# Problem Statement:
# Write program that converts the given milliseconds into hours, minutes, and seconds. The program should convert only from milliseconds to hours/minutes/seconds, 
# not vice versa and during the conversion following notes should be taken into consideration.
